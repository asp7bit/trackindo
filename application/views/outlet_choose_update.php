...
<body>
  ...
  <div class="row">
    <div class="twelve columns special head">
      <h1>Trakindo</h1>
      <h2> <span>Update New Outlet <span></span> </span></h2>      
      <?php echo form_open('outlet/update') ?>
      <?php foreach($get_outlet as $data){ ?>
      <input type="hidden" name="id" value="<?php echo $data->id ?>">
      <input type="text" name="name" placeholder="Outlet Name" value="<?php echo $data->name ?>">
      <input type="text" name="email" placeholder="Outlet Email" value="<?php echo $data->email ?>">
      <input type="text" name="address" placeholder="Outlet Address" value="<?php echo $data->address ?>">
      <input type="password" name="password" placeholder="Outlet Password" value="<?php echo $data->password ?>">
      <input type="text" name="device_id" placeholder="Outlet ID Device" value="<?php echo $data->device_id ?>">
      <input type="text" name="auth_token" placeholder="Token Auth" value="<?php echo $data->auth_token ?>">
